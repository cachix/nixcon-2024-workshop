...
mod tests {
    ...
    async fn test_get_flake_with_params() {
        ...
        let response = app.get("/flake?q=search").send().await.unwrap();
    ...
    async fn test_get_flake_with_params_no_result() {
        ...
        let response = app.get("/flake?q=nothing").send().await.unwrap();
        assert_eq!(response.status(), StatusCode::OK);
    ...
    async fn test_get_flake_without_params() {
        ...
        let response = app.get("/flake").send().await.unwrap();
        assert_eq!(response.status(), StatusCode::OK);
